...
ruled.client.connect_signal('request::rules', function()
    ...
    ruled.client.append_rule {
        id = 'looking-glass',
        rule_any = {class = {'looking-glass-client', 'Virt-manager'}},
    ...
    ruled.client.append_rule {
        ...
        rule_any = {
            class = {
                'dolphin-emu', 'Steam', 'Lutris', 'Citra', 'supertuxkart',
                'Moonlight', 'retroarch', 'yuzu', 'pcsx2'
            },
            name = {
                'Steam', 'Lutris', 'Moonlight', 'RetroArch', 'yuzu', 'PCSX2'
            }
        },
        properties = {
            tag = '4',
    ...
    ruled.client.append_rule {
        id = 'graphics',
        rule_any = {class = {'Gimp', 'Inkscape', 'Flowblade'}},
...
client.connect_signal('property::class', function(c)
    if c.class == 'Spotify' then
        ...
        local app_count = 0
        for c in awful.client.iterate(app) do app_count = app_count + 1 end
