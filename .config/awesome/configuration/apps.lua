...
return {
	...
	run_on_start_up = {
		...
		-- Start lockscreen process in background
		'xss-lock --transfer-sleep-lock -- ~/.local/share/lock.sh',

		-- Syncthing
		'syncthing',

		-- Set keyboard language to HR (Croatian)
		'setxkbmap hr',

		-- Set displays to office monitors and restart AwesomeWM
		'officemon && echo "awesome.restart()" | awesome-client'
	},
